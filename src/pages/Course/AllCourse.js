...
export default function AllCourse(props) {
  ...
  const { mangKhoaHoc, mangDMKhoaHoc, mangKHTheoDanhMuc } = useSelector(
      ...
      <div className="allCourse-body">
        <div className="row">
          ...
          <div className="col-10">
            {
              <TableItemCourse
                mangKhoaHoc={value === false ? mangKhoaHoc : mangKHTheoDanhMuc}
                courseOfUser={
                  thongTinTK ? thongTinTK.chiTietKhoaHocGhiDanh : ''
                }
              />
            }
          </div>
